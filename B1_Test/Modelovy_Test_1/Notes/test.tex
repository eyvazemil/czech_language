...
\subsection{Otázky}
\begin{enumerate}
    \item V sobotu v noci si v Českém Krumlově můžete bezplatně prohlédnout muzea a galerie: Ano.
    \item V Museu Fotoateliér Seidel je výstava historických rodinných fotografií: Ne.
    \item Za vstupné do zámku zaplatí dospělá osoba s dítětem více než bez něj: Ne.
    \item Během prohlídky grafitového dolu musíte mít speciální oblečení a boty: Ano.
    \item Prohlídky zámku jsou častěji než prohlídky grafitového dolu: Ano.
    \item Návštěva grafitového dolu je delší než návštěva zámeckých sklepů: Ano.
    \item V letohrádku Bellarie se během slavností budou konat koncerty: Ne.
    \item Zahraniční hudba bude na programu během celého víkendu: Ne.
    \item Připravený dětský program je v neděli delší než v sobotu: Ne.
\end{enumerate}
...
\part{Psaní}
\section{Úloha 1 --- Dotazník}
\subsection{Proč jste si výlet vybral/a?}
Vybral jsem výlet, protože měl velmi moc prace minulé tydny.
Ukončili jsme jeden projekt a hned máme novy projekt, proto to myslil 
že potřebuju vylet až na jeden den.
Slyšel že z kolegovi že ten kancelař "CestujTam" má velmi dobré vylety a 
chtěl jsem zkusit jeden z ty vylety.

\subsection{S čím jste byl/a na výletě spokojen/a?}
Byl spokojen s programou, ktera byla připravena tím kancelařem.
Uviděl jsem divní místa. Taky libí se mně že seznamil jsem z mnohé lid'mi 
přes ten výlet.

\subsection{Co byste na výletě změnil/a?}
Níc bych nezměnil, protože měl velmi dobré užitosti.


\section{Úloha 2 --- Neformální dopis}
\subsection{Jídlo je radost}
Ahoj Jamale,

Nepsál jsem tobě moc dlouho, jak se máš?

Na poslední schůzce jsi řekl, že chcel jít do Mílanu, protože jídlo tám velmí dobra,
chcel jsem říct, že na naše zemí, v Azerbajdžánu, jídlo je taky velmí dobře.

Mám ted' dovolenou v Azerbajdžanu a jím naše tradiční jídlo, víš jaké naše nacionalné
kuchyně, protože jsi taky z toto zemí.

Ja tady jím mnohem víc masa, především jehněči maso z ryže nebo s naším tradíčním chlebom.

Taky měl mnoho krát náš tradíční čaj z ovoce, přičemž ovoce tady jsou moc chutně a levnejši než v Evrope.

A když vratíš jsi z Milanu a ja vratím z Azerbajdžánu, půjdeme spolu do Česke restaurace, protože ted' mám chut' na svičkovu a pívo :)
